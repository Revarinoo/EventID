<%@ Page Title="" Language="C#" MasterPageFile="~/View/Site1.Master" AutoEventWireup="true" CodeBehind="EditItems.aspx.cs" Inherits="EventID.View.EditItems" %>
    ...
    <div class="container">
        <div class="form-horizontal">
            ...
            <div class="form-group">
                <div class="col-md-6">
                    <div class="col-md-6">
                        <asp:Button ID="btnEdit" CssClass="btn btn-primary" runat="server" Text="Edit Product" OnClick="btnEdit_Click" /> 
                        <br />
                        <asp:Button ID="btnDelete" CssClass="btn btn-danger mt-3" runat="server" Text="Delete Product" OnClick="btnDelete_Click" />
                    </div>
                </div>
            </div>
            <div class="form-group">
