<%@ Page Title="" Language="C#" MasterPageFile="~/View/Site2.Master" AutoEventWireup="true" CodeBehind="Planner-MC.aspx.cs" Inherits="EventID.View.Planner_MC" %>
    ...
    <div class="venue">
        <div class="venue-container cf">
            ...
            <div class="choose">
                ...
                <asp:Button ID="BtnMale" Text="Male" runat="server" class="btn btn-primary btnLoginBackground" OnClick="BtnMale_Click" />
                <asp:Button ID="BtnFemale" Text="Female" runat="server" class="btn btn-primary btnLoginBackground" OnClick="BtnFemale_Click" />
            </div>
            <div class="row">
