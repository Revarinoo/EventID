<%@ Page Title="" Language="C#" MasterPageFile="~/View/Site2.Master" AutoEventWireup="true" CodeBehind="Planner-Venue.aspx.cs" Inherits="EventID.View.Planner_Venue" %>
    ...
    <div class="venue">
        <div class="venue-container cf">
            ...
            <div class="choose">
                ...
                <asp:Button ID="BtnBallroom" Text="Ballroom" runat="server" class="btn btn-primary btnLoginBackground" OnClick="BtnBallroom_Click" />
                <asp:Button ID="BtnAF" Text="Aula & Function Hall" runat="server" class="btn btn-primary btnLoginBackground" OnClick="BtnAF_Click" />
                <asp:Button ID="BtnResort" Text="Resort" runat="server" class="btn btn-primary btnLoginBackground" OnClick="BtnResort_Click" />
                <asp:Button ID="BtnRC" Text="Restaurant & Cafe" runat="server" class="btn btn-primary btnLoginBackground" OnClick="BtnRC_Click" />
            </div>
