<%@ Page Title="" Language="C#" MasterPageFile="~/View/Site2.Master" AutoEventWireup="true" CodeBehind="Planner-Musician.aspx.cs" Inherits="EventID.View.Planner_Musician" %>
    ...
    <div class="venue">
        <div class="venue-container cf">
            ...
            <div class="choose">
                ...
                <asp:Button ID="BtnFB" Text="Full Band" runat="server" class="btn btn-primary btnLoginBackground" OnClick="BtnFB_Click" />
                <asp:Button ID="BtnAB" Text="Acoustic Band" runat="server" class="btn btn-primary btnLoginBackground" OnClick="BtnAB_Click" />
                <asp:Button ID="BtnSO" Text="Single Organ" runat="server" class="btn btn-primary btnLoginBackground" OnClick="BtnSO_Click" />
            </div>
            <div class="row">
